...
export const newsPosts = [
  {
    type: "news",
    slug: "dpautomation-machine-library-launch",
    title: "DP Automation Machine Library Now Live: 10 Machines, Full Depth",
...
Browse the full library at the Machine Library page.`,
  },
  {
    ...
    title: "12 Engineering Calculators Added to DP Automation",
...
All calculators run instantly in the browser with no sign-up required. Try them on the Calculators page.`,
  },
  {
    ...
    authorName: "DP Automation Team",
    content: `Two new ways to get help are live on DP Automation. The Community Forum lets you ask questions, post projects, comment, like, and follow other engineers — with reputation points earned for contributing. The AI Assistant answers PLC, HMI, VFD, and troubleshooting questions instantly, trained to stay focused on practical, technically accurate industrial automation help.
